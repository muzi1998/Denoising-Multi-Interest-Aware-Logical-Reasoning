...
from models.NCR_BetaE_MI_no_rule import NCR
...
def main():
    ...
    args.dataset = 'Movies_and_TV_100'# ML1M  Movies_and_TV_100 Electronics books
    args.metric = 'ndcg@10'
    args.max_his = 10#10 50 100
    args.ML_num = 5 # 3,5,7,9,11
    args.ML_iter = 5
    args.test_neg_n = 100
    # args.ML_model = 'DR_beta_fuse'# NCR_BetaE_MI_no_rule.py
    args.ML_model = 'SA_beta_fuse'  # NCR_BetaE_MI_no_rule.py
    log_file_name = [str(init_args.rank), init_args.model_name,
                     ...
                     'dropout=' + str(args.dropout), 'batch_size=' + str(args.batch_size), 'ML_model='+ str(args.ML_model), 'his_length='+ str(args.max_his), 'ML_num='+ str(args.ML_num)]
    ...
    if init_args.model_name in ['BaseModel']:
        ...
        model = model_name(label_min=data_loader.label_min, label_max=data_loader.label_max,
                           ...
                           random_seed=args.random_seed, model_path=args.model_path, number_interest = args.ML_num,number_iter = args.ML_iter)
        # model = model_name(label_min=data_loader.label_min, label_max=data_loader.label_max,
        #                    feature_num=0,
        #                    user_num=data_loader.user_num, item_num=data_loader.item_num,
        #                    u_vector_size=args.u_vector_size, i_vector_size=args.i_vector_size,
    ...
    # save test results
    np.save(args.result_file, runner.evaluate(model, data_processor.get_test_data(), data_processor))
