...
class MIND(th.nn.Module):
    def __init__(self, args, embedNum):
        ...
        self.D = args.D #dimension of simple
        self.K = args.K #number of interest
        self.R = args.R #number of iteration
        self.L = args.seq_len
    ...
    def data_obtain(self, feed_dict):
