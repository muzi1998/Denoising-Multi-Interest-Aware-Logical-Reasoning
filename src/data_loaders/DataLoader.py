...
class DataLoader(object):
    ...
    def __init__(self, path, dataset, label='label', load_data=True, sep='\t', seqs_sep=','):
        ...
        # self.user_file = r'D:\lifei\code\code_21WWW_Neural Collaborative Reasoning\NCR-main\dataset\ml100k01-1-5\ml100k01-1-5.train.csv'
        self.item_file = os.path.join(self.path, dataset + global_p.ITEM_SUFFIX)
        # self.item_file = r'D:\lifei\code\code_21WWW_Neural Collaborative Reasoning\NCR-main\dataset\ml100k01-1-5\ml100k01-1-5.train.csv'
    ...
    def _load_user_item(self):
        ...
        :return:
        """
        print(os.path.exists(self.user_file))
    ...
    def _load_data(self):
        ...
        if os.path.exists(self.train_file) and self.load_data:
            ...
            if 'reasoner' in self.train_file:
                self.train_df = pd.read_csv(self.train_file)
            elif 'software' in self.train_file:
                self.train_df = pd.read_csv(self.train_file)
            elif 'books_100' in self.train_file:
                self.train_df = pd.read_csv(self.train_file)[['userId', 'itemId', 'rate']]
                self.train_df.columns = ['uid', 'iid', 'label']
                self.train_df['label'] = self.train_df['label'].apply(lambda x: 1 if x > 3 else 0)
            elif 'Movies_and_TV_100' in self.train_file:
                self.train_df = pd.read_csv(self.train_file)[['userId', 'itemId', 'rate']]
                self.train_df.columns = ['uid', 'iid', 'label']
                self.train_df['label'] = self.train_df['label'].apply(lambda x: 1 if x > 3 else 0)
            elif 'books' in self.train_file:
                self.train_df = pd.read_csv(self.train_file)
            elif 'Cell_Phones' in self.train_file:
                self.train_df = pd.read_csv(self.train_file)[['userId', 'itemId', 'rate']]
                self.train_df.columns = ['uid', 'iid', 'label']
                self.train_df['label'] = self.train_df['label'].apply(lambda x: 1 if x > 3 else 0)
            elif 'Electronics' in self.train_file:
                self.train_df = pd.read_csv(self.train_file)[['userId', 'itemId', 'rate']]
                self.train_df.columns = ['uid', 'iid', 'label']
                self.train_df['label'] = self.train_df['label'].apply(lambda x: 1 if x > 3 else 0)
            elif 'Movies_and_TV' in self.train_file:
                self.train_df = pd.read_csv(self.train_file)[['userId', 'itemId', 'rate']]
                self.train_df.columns = ['uid', 'iid', 'label']
                self.train_df['label'] = self.train_df['label'].apply(lambda x: 1 if x > 3 else 0)
            elif 'ML1M' in self.train_file:
                self.train_df = pd.read_csv(self.train_file)[['userId', 'itemId', 'rate']]
                self.train_df.columns = ['uid', 'iid', 'label']
                self.train_df['label'] = self.train_df['label'].apply(lambda x: 1 if x > 3 else 0)
            else:
        ...
        if os.path.exists(self.validation_file) and self.load_data:
            ...
            if 'reasoner' in self.validation_file:
                self.validation_df = pd.read_csv(self.validation_file)
            elif 'software' in self.validation_file:
                self.validation_df = pd.read_csv(self.validation_file)
            elif 'books_100' in self.validation_file:
                self.validation_df = pd.read_csv(self.validation_file)[['userId', 'itemId', 'rate']]
                self.validation_df.columns = ['uid', 'iid', 'label']
                self.validation_df['label'] = self.validation_df['label'].apply(lambda x: 1 if x > 3 else 0)
            elif 'Movies_and_TV_100' in self.validation_file:
                self.validation_df = pd.read_csv(self.validation_file)[['userId', 'itemId', 'rate']]
                self.validation_df.columns = ['uid', 'iid', 'label']
                self.validation_df['label'] = self.validation_df['label'].apply(lambda x: 1 if x > 3 else 0)
            elif 'books' in self.validation_file:
                self.validation_df = pd.read_csv(self.validation_file)
            elif 'Cell_Phones' in self.validation_file:
                self.validation_df = pd.read_csv(self.validation_file)[['userId', 'itemId', 'rate']]
                self.validation_df.columns = ['uid', 'iid', 'label']
                self.validation_df['label'] = self.validation_df['label'].apply(lambda x: 1 if x > 3 else 0)
            elif 'Electronics' in self.validation_file:
                self.validation_df = pd.read_csv(self.validation_file)[['userId', 'itemId', 'rate']]
                self.validation_df.columns = ['uid', 'iid', 'label']
                self.validation_df['label'] = self.validation_df['label'].apply(lambda x: 1 if x > 3 else 0)
            elif 'Movies_and_TV' in self.validation_file:
                self.validation_df = pd.read_csv(self.validation_file)[['userId', 'itemId', 'rate']]
                self.validation_df.columns = ['uid', 'iid', 'label']
                self.validation_df['label'] = self.validation_df['label'].apply(lambda x: 1 if x > 3 else 0)
            elif 'ML1M' in self.validation_file:
                self.validation_df = pd.read_csv(self.validation_file)[['userId', 'itemId', 'rate']]
                self.validation_df.columns = ['uid', 'iid', 'label']
                self.validation_df['label'] = self.validation_df['label'].apply(lambda x: 1 if x > 3 else 0)
            else:
        ...
        if os.path.exists(self.test_file) and self.load_data:
            ...
            if 'reasoner' in self.test_file:
                self.test_df = pd.read_csv(self.test_file)
            elif 'software' in self.test_file:
                self.test_df = pd.read_csv(self.test_file)
            elif 'books_100' in self.test_file:
                self.test_df = pd.read_csv(self.test_file)[['userId', 'itemId', 'rate']]
                self.test_df.columns = ['uid', 'iid', 'label']
                self.test_df['label'] = self.test_df['label'].apply(lambda x: 1 if x > 3 else 0)
            elif 'Movies_and_TV_100' in self.test_file:
                self.test_df = pd.read_csv(self.test_file)[['userId', 'itemId', 'rate']]
                self.test_df.columns = ['uid', 'iid', 'label']
                self.test_df['label'] = self.test_df['label'].apply(lambda x: 1 if x > 3 else 0)
            elif 'books' in self.test_file:
                self.test_df = pd.read_csv(self.test_file)
            elif 'Cell_Phones' in self.test_file:
                self.test_df = pd.read_csv(self.test_file)[['userId', 'itemId', 'rate']]
                self.test_df.columns = ['uid', 'iid', 'label']
                self.test_df['label'] = self.test_df['label'].apply(lambda x: 1 if x > 3 else 0)
            elif 'Electronics' in self.test_file:
                self.test_df = pd.read_csv(self.test_file)[['userId', 'itemId', 'rate']]
                self.test_df.columns = ['uid', 'iid', 'label']
                self.test_df['label'] = self.test_df['label'].apply(lambda x: 1 if x > 3 else 0)
            elif 'Movies_and_TV' in self.test_file:
                self.test_df = pd.read_csv(self.test_file)[['userId', 'itemId', 'rate']]
                self.test_df.columns = ['uid', 'iid', 'label']
                self.test_df['label'] = self.test_df['label'].apply(lambda x: 1 if x > 3 else 0)
            elif 'ML1M' in self.test_file:
                self.test_df = pd.read_csv(self.test_file)[['userId', 'itemId', 'rate']]
                self.test_df.columns = ['uid', 'iid', 'label']
                self.test_df['label'] = self.test_df['label'].apply(lambda x: 1 if x > 3 else 0)
            else:
